...
// The variable dishName stores a string. This is because JS implicitly coerces
// the values inside the arrays to strings and concatenates them. Thus the
// expression on right hand side of the statement evaluates to a String type.
// Since, Array.prototype.join() is not avaiable for String data types. The
// solution returns an TypeError.