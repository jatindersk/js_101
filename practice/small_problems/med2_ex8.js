...
//  - ignore the words which have a sequence of spaces or ., !, ?
//  - log the longest sentence and the count of it's words on the console
// - if a character is not (., !, ? or space) then immediately increase the
//  count
...
//       if (specialChar.includes(wordArr[idx])) {
//         checkSequence(word);
//       }
//     }
//   });
...
longestSentence("To be or not to be! Is that  klk  the sa question?");
// To be or not to be!
//
